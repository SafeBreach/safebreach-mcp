...
5. `get_integrations` ✨ **NEW** - Filtered, paginated catalog of AVAILABLE SIEM/TI connector TYPES
...
6. `get_installed_integrations` ✨ **NEW** - Filtered, paginated list of INSTALLED SIEM connectors,
