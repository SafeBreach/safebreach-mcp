...
class TestPlaybookQAFixes:
    ...
    def test_sb_get_playbook_attacks_id_range_validation(self):
        ...
        with patch('safebreach_mcp_playbook.playbook_functions._get_all_attacks_from_cache_or_api') as mock_get_attacks:
            ...
            try:
                result = sb_get_playbook_attacks(console="demo-console", id_min=100, id_max=200)
        ...
        with pytest.raises(ValueError) as exc_info:
            sb_get_playbook_attacks(console="demo-console", id_min=200, id_max=100)
    ...
    def test_sb_get_playbook_attacks_date_range_validation(self):
        ...
        with patch('safebreach_mcp_playbook.playbook_functions._get_all_attacks_from_cache_or_api') as mock_get_attacks:
            mock_get_attacks.return_value = []
            try:
                result = sb_get_playbook_attacks(console="demo-console", modified_date_start="2022-01-01", modified_date_end="2022-12-31")
                # Should succeed - no exception expected
            except ValueError:
        ...
        with pytest.raises(ValueError) as exc_info:
            sb_get_playbook_attacks(console="demo-console", modified_date_start="2022-12-31", modified_date_end="2022-01-01")
        ...
        with patch('safebreach_mcp_playbook.playbook_functions._get_all_attacks_from_cache_or_api') as mock_get_attacks:
            mock_get_attacks.return_value = []
            try:
                result = sb_get_playbook_attacks(console="demo-console", published_date_start="2022-01-01", published_date_end="2022-12-31")
                # Should succeed - no exception expected
            except ValueError:
        ...
        with pytest.raises(ValueError) as exc_info:
            sb_get_playbook_attacks(console="demo-console", published_date_start="2022-12-31", published_date_end="2022-01-01")
    ...
    def test_sb_get_playbook_attacks_page_number_validation(self):
        ...
        with patch('safebreach_mcp_playbook.playbook_functions._get_all_attacks_from_cache_or_api') as mock_get_attacks:
            mock_get_attacks.return_value = []
            try:
                result = sb_get_playbook_attacks(console="demo-console", page_number=0)
                # Should succeed - no exception expected
            except ValueError:
        ...
        with pytest.raises(ValueError) as exc_info:
            sb_get_playbook_attacks(console="demo-console", page_number=-1)
